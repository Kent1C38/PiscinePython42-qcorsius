class Player:
    def __init__(self, name: str, score: int, achievements: set[str]):
        self.__name = name
        self.__score = score
...
def list_comprehension_tests(players_list: list[Player]):
...
def show_global_analytics(players_list: list[Player]):
    print("\n=== Global Analysis ===")
